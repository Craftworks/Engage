package Engage::Helper::Daemontools::Job;

=head1 NAME

Engage::Helper::Daemontools::Job- Helper for daemontools run scripts

=head1 SYNOPSIS

  script/create.pl Daemontools::Job [ UserName ]
